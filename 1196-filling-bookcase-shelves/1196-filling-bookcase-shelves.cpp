class Solution {
private:
    int solve(vector<vector<int>>& books, int i, int remShelfWidth,
              int maxShelfHeight, int shelfWidth, vector<vector<int>>& dp) {
        if (i == books.size()) {
